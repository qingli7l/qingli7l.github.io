...
Qing Li joined the Department of Cardiovascular Sciences at Houston Methodist and Weill Cornell Medical College as a Postdoctoral Fellow, working with [Prof. Guangyu Wang](https://guangyuwanglab.github.io/web/). She develops computational models and big data analytics to resolve complex biological problems, especially in single-cell dynamics and spatial biology. Prior to this, she completed a one-year postdoctoral fellowship at the Department of Computer Science and Engineering, The Chinese University of Hong Kong (CUHK), under the mentorship of [Prof. Yu Li](https://liyu95.com/). She also spent one year as a research intern at the National Laboratory of Pattern Recognition (NLPR), Institute of Automation, Chinese Academy of Sciences (CAS), supervised by [Prof. Chenglin Liu](https://people.ucas.ac.cn/~liuchenglin). She obtained her Ph.D. in Computer Science from the Chongqing Institute of Green and Intelligent Technology, CAS (jointly with CQUPT) in 2023. She earned her Master’s degree in Computer Science from the University of Chinese Academy of Sciences (UCAS) in 2019. She received her Bachelor’s degree from Sichuan Normal University in 2016. 

Research Interests: Computational Biology, Big Data Analysis, and Evolutionary Computation. She is open to discussions and collaborations. 
